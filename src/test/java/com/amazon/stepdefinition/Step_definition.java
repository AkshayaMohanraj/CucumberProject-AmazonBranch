...
//	    elementClick(pm.getHomePage().getSignInBtn());
	    elementClickusingActions(pm.getHomePage().getSignInBtn());
	}
	
//	@When("^User click on Hello sign in$")
//	public void user_click_on_Hello_sign_in() throws Throwable {
...
//	}
	...
	public void user_verify_the_username_Hello_Akshaya_in_the_header_page() throws Throwable {
