...
And User enter the username '9486294120' in the emailid/mobile number
And User click on continue button
Then User verify the entered mobile number '+919486294120' displays on the mobile number feild
When User enter the password '643003' in the password feild
And User click on login button
And User wait for '3' seconds
Then User verify the username 'Hello, Akshaya' in the header page
...
|+918122447745	|8148181640	|Hello, Akshaya	|
